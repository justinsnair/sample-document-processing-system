...
try
{
    ...
    {
        // Second: Fallback - try configuration connection string
        ...
        dbInfo.DatabaseType = "PostgreSQL (Fallback)"; dbInfo.SecretName = "appsettings.json"; dbInfo.HostAddress = "localhost";
